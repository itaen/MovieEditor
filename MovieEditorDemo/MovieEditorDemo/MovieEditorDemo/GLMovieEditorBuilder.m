...
+ (NSArray<GLEditVideoModel *> *)GetEditVideoModels:(NSArray<NSURL *> *)fileURLS photoModels:(NSArray<GLEditPhotoModel *> *)photoModels{
    NSMutableArray <GLEditVideoModel *> *videoModels = [NSMutableArray array];
    [fileURLS enumerateObjectsUsingBlock:^(NSURL * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        NSDictionary *options = @{AVURLAssetPreferPreciseDurationAndTimingKey:@YES};
        AVURLAsset *asset = [[AVURLAsset alloc] initWithURL:obj options:options];
        GLEditVideoModel *videoModel = [[GLEditVideoModel alloc] init];
        videoModel.duration = CMTimeGetSeconds(asset.duration);
        ...
        videoModel.originImageData = photoModels[idx].originPhotoData;
		videoModel.resizeImageData = photoModels[idx].resizePhotoData;
